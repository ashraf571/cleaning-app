...
import officeFloar from "@/assets/images/serviceSectionImage/officeCleaning2.webp";
...
import carpetImage from "@/assets/images/serviceSectionImage/carpetCleaning1.webp";
import carpetWhite from "@/assets/images/serviceSectionImage/carpetCleaning4.webp";
...
export interface ServiceContentSectionIF {
  heading?: string;
  paragraphs?: string[];
  paragraphs1?: string[];
  list?: string[];
...
export interface ServiceDataIF {
