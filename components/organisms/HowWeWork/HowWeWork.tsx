                        ...
                        >
                            <div className=" relative font-bold flex justify-center flex-col text-base p-8">
                                <div className=" relative flex justify-center items-center">
                                    <span className="absolute text-lightGray text-[120px] leading-[86px] -z-1 -top-[55px] text-primaryGray">{ card.number }</span>
                                    <span className="h-16 w-16 shadow-lg shadow-[#0049764b] bg-white flex justify-center items-center rounded-[50%] absolute top-0 left-2 z-10" >{ card.number }</span>

                                    <Image width={100} height={100} className=" z-0 w-56 h-56 items-center rounded-[50%] " src={card.image} alt="cleaning team" />
                                </div>
                                <h2 className="mt-6 text-center text-2xl"> { card.heading } </h2>
                            </div>
