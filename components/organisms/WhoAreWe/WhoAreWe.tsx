  ...
  return (
    <div className=" py-10 flex w-full justify-center items-center">
      <div className=" container flex justify-between ">
        ...
        <MovingImage image={CleaningOffice.src} />
        </div>
        <div className=" flex flex-col text-cyanblue align-middle h-full max-w-[50%] mt-10 px-16">
          ...
          <div className=" text-base w-full mt-none-20">
            <div className="flex " >
            <div className="flex w-1/2 gap-2 items-center mt-4">
              <div className="icon">
                <svg
                  aria-hidden="true"
                  className=" h-10 w-12 e-font-icon-svg e-fas-money-bill"
                  viewBox="0 0 640 512"
            ...
            <div className="flex w-1/2 gap-2 items-center mt-4">
              <div className="icon">
                <svg
                  aria-hidden="true"
                  className=" h-10 w-12 e-font-icon-svg e-fas-people-carry"
                  viewBox="0 0 640 512"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <div className="flex w-1/2 gap-2 items-center mt-4">
              <div className="icon">
                <svg
                  aria-hidden="true"
                  className=" h-10 w-12 e-font-icon-svg e-fas-globe-americas"
                  viewBox="0 0 496 512"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <div className="flex w-1/2 gap-2 items-center mt-4">
              <div className="icon">
                <svg
                  aria-hidden="true"
                  className=" h-10 w-12 e-font-icon-svg e-fas-check-circle"
                  viewBox="0 0 512 512"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <span>100% Satisfaction Guarnateed</span>
            </div>
            </div>
          </div>
        </div>
